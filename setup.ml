...
(* OASIS_START *)
(* DO NOT EDIT (digest: 40da9cbfe64b829375e0d036945ad2fd) *)
(*
...
let setup_t =
  {
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "ac.ml"});
               Executable
                 ({
                     cs_name = "acpc_big";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "big_ac.ml"});
               Executable
                 ({
                     cs_name = "acpc_mol2tool";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "mol2_tool.ml"})
            ];
          plugins = [];
     ...
     oasis_version = "0.4.1";
     oasis_digest =
       Some "=\224`\156\149\021\160\030N\023b\136\154\195\164\141";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
